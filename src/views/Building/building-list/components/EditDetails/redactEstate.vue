                ...
                <div>
                    <el-form-item label="选择项目">
                        <el-select placeholder="请选择城市公司" v-model="addForm.city" value-key="id">
                            <el-option v-for="(item, index) in cityOption" :key="index" :label="item.orgUnitName" :value="item"></el-option>
                        </el-select>
...
<script>
import {cityList, projectList, append, buildingInfo} from '@/api/building-list.js'
    ...
    export default {
        ...
        watch: {
			"addForm.city": function(e) {
                ...
                if( e && e.orgUnitCode ){
                    this.handleprojectList(e.orgUnitCode);
                }
