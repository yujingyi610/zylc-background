                ...
                <el-row :gutter="20">
                  ...
                  <el-col :span="7">
                    <el-form-item label="标题:">
                      <el-input v-model="item.spokesman" placeholder="请输入标题" />
                    </el-form-item>
                  </el-col>
                  <el-col :span="8">
                    <el-form-item :prop="'param.' + index + '.url'" :rules="urlRule" label="菜单链接:">
                      <el-input v-model="item.url" placeholder="请输入菜单链接" />
                    </el-form-item>
                  </el-col>
                  <el-col :span="5">
                    <el-form-item :rules="sortRule" :prop="'param.' + index + '.sort'" label="排序：">
                      <el-input v-model.number="item.sort" placeholder="排序"/>
                    </el-form-item>
                  </el-col>
                  <br/><br/><br/>
                  <el-col :span="20">
                    <el-form-item label="内容：">
                      <el-input v-model.number="item.content" :autosize="{ minRows: 4, maxRows: 5}" placeholder="请输入描述" type="textarea"/>
                    </el-form-item>
                  </el-col>
                </el-row>
              </el-card>
...
import { newsEdit, newsDel } from 'api/home/index/edit.js'
