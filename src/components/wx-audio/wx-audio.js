...
(function (window, document) {
	...
	Wxaudio.prototype = {
		...
		initDom: function () {
			...
			this.wxAudioStateImg.src = 'static/audio_images/pause.png'
		...
		initAudioEvent: function () {
			...
			_this.wxAudio.onplaying = function () {
				...
				_this.wxAudioStateImg.src = 'static/audio_images/playing.gif'
			},
			_this.wxAudio.onpause = function () {
				_this.isPlaying = false
				_this.showLoading(false)
				_this.wxAudioStateImg.src = 'static/audio_images/pause.png'
			},
